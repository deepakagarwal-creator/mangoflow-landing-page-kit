    ...
    <footer className="bg-gray-900 text-gray-300 py-12">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm">© 2025 MangoFlow. All rights reserved.</p>
          ...
          <div className="mt-4 md:mt-0">
            <form className="flex">
              <Input 
                ...
                className="bg-gray-800 border-gray-700 text-gray-300 rounded-r-none focus:ring-mango-400 focus:border-mango-400"
              />
              <Button className="rounded-l-none bg-mango-400 hover:bg-mango-500">
                Subscribe
              </Button>
            </form>
          </div>
